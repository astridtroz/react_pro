  ...
  return (
    <div className="w-full h-screen duration-200" style={{backgroundColor:color}}>
      ...
      <div className="flex flex-wrap justify-center gap-3 bg-white rounded-3xl shadow-lg px-3 py-2">
          ...
          <button
           onClick={()=> setColor("red")} //onclick takes a handler function , setcolor is a function that returns red to the handler
           //handler changes bg color by updating color variable
